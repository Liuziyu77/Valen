<p align="center">
  <img src="assets/branding/valen-logo-v5.png" alt="Valen — a teal aperture with a forward arrow and uppercase wordmark" width="720">
</p>
...
| Qwen3.5-2B | Base model | [🤗 Hugging Face](https://huggingface.co/Qwen/Qwen3.5-2B) |
...
**Lower latency, higher accuracy.** General is on the left (5,000 questions); Sokoban is on the right (500 single-step questions from 100 levels). The upper-left direction is better.

<p align="center">
  <a href="assets/figures/evaluation-overview.png"><img src="assets/figures/evaluation-overview.png" alt="Accuracy versus latency on General and Sokoban: mean end-to-end latency on the x-axis and accuracy on the y-axis." width="1200"></a>
</p>

**Valen-2B(SFT) reaches 79.02% on General**, and **Valen-2B(RL) reaches 87.60% on Sokoban**. `RL` denotes RLCD. Each panel uses models trained for that task; the Sokoban score measures single-step accuracy.
